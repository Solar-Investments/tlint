...
use Tighten\TLint\Linters\LeadingSlashesOnRoutePaths as Linter;

use function array_slice;

class LeadingSlashesOnRoutePaths extends BaseFormatter
{
            ...
            public function enterNode(Node $node): Node|int|null
            {
                ...
                return new StaticCall(
                    ...
                    [
                        new Arg(
                            new String_(
                                Str::of($node->args[0]->value->value)->start('/')
                            )
                        ),
